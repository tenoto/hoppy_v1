...
BG_GROUP_3C50_TABLE  = "%s/bg_group_3C50.table" % os.getenv("NICER_BGD_LIBRARY_PATH")
DAY_NOISE_3C50_TABLE = "%s/day_noise_3C50.table" % os.getenv("NICER_BGD_LIBRARY_PATH")
NUM_of_MPU = 7
NUM_of_FPM = 8
NUM_of_IBG = 5
NUM_of_HREJ = 6
