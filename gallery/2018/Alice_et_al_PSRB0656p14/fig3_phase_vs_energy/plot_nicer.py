...
PI_TO_KEV = 0.01
EVENT_FILE = '/Users/enoto/Dropbox/enoto/research/nicer/analysis/psrb0656/fig/fig3_phase_vs_energy/psrb0656p14_pulsephase.evt'
ebin = 60
pbin = 30
emin = 0.2
emax = 1.3 
...
cmd  = 'rm -f psrb0656p14_nicer_hist2d.pdf psrb0656p14_nicer_hist2d_pulsed.pdf;'
cmd += 'rm -f psrb0656p14_nicer_hist2d.eps psrb0656p14_nicer_hist2d_pulsed.eps'
...
fig.savefig('psrb0656p14_nicer_hist2d.pdf')
fig.savefig('psrb0656p14_nicer_hist2d.eps')
...
fig.savefig('psrb0656p14_nicer_hist2d_pulsed.pdf',dpi=200)
fig.savefig('psrb0656p14_nicer_hist2d_pulsed.eps',dpi=200)
